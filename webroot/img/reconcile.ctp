                           ...
                           <div class="row">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                              ...
                              <div class="col-md-10"><textarea  readonly name="comment" form="usrform" class="form-control reconsile" placeholder="Description"><?php echo $reconcileOrg[1]['description']; ?></textarea></div>
                            </div>
                        ...
                        <div class="form-group" id="finalReconsile">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                              <div class="col-md-12"><textarea  name="description" class="form-control reconsile" placeholder="Description"></textarea></div>
