...
function init_IonRangeSlider() {
    ...
    $("#rangeHour").ionRangeSlider( {
        type: "single",hide_min_max: true, min: 0, max: 23,  grid_snap: !0, force_edges: !0, grid: !0
    }),
    $("#rangeTime").ionRangeSlider( {
        hide_min_max: true,type: "single", min: 0, max: 59,  grid_snap: !0, force_edges: !0, grid: !0
    }),
     $("#daysOfWeek").ionRangeSlider( {
        hide_min_max: true,type: "single", values: ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'],  grid_snap: !0, force_edges: !0, grid: !0
    })
}
